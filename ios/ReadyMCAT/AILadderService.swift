...
// that — parsing the MCQ rungs, the three guardrails, the retry loop, per-note
// caching — is unchanged, so behavior (and the eval-scored guardrails) match
// exactly. Each returned rung is an interactive multiple-choice question.
