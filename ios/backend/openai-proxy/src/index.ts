...
// `ios/ReadyMCAT/LadderGen.swift` (same system message, same 2-4 rung rule, same
// gpt-4o-mini @ temperature 0.4, same `response_format: {type:"text"}`). The
// Worker deliberately does NOT parse/validate the ladder: the iOS client keeps
// running the byte-identical parser + three guardrails (schema / answer-leak /
