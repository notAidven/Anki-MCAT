...
All questions are **original**, authored from general subject-matter knowledge of psychology, sociology, and behavioral biology and grounded in **free / openly-licensed** references. **No item was copied, scraped, or closely paraphrased from any copyrighted or paid question bank** (e.g., UWorld, Kaplan, Blueprint, AAMC paid materials). The exam's public MCQ _style_ is emulated, but all stems, options, explanations, and sub-questions are written from scratch, and the underlying facts used are non-copyrightable (theorists, definitions, mechanisms) verified for correct attribution.
